...
//LoRaMac-definitions.h文件140行有详细说明
/*!
...
static void OnRadioTxDone( void )
{
    ...
    // Setup timers
    //涓嬭鏁版嵁鐨勫紑濮嬶紝鏄湪鍙戦�佸畬鎴愬悗锛屽欢鏃朵竴娈垫椂闂达紝鍒嗗埆寮�鍚疪X1鍜孯X2鎺ユ敹绐楀彛
...
static void OnRxWindow1TimerEvent( void )
{
    ...
    //鍒╃敤 ( Channel % 48 ) 灏嗕笂琛屼俊閬撳垎涓?~7锛屽垎鍒笌涓嬭淇￠亾鐨?~7瀵瑰簲
#elif defined( USE_BAND_470 ) || defined( USE_BAND_470PREQUEL )
...
#elif defined( USE_BAND_470 ) || defined ( USE_BAND_470PREQUEL )
//但是……1301/1308网关芯片只有8个上行信道，所以需要设置SDK的信道掩码，只开启需要的信道
    LoRaMacParamsDefaults.ChannelsMask[0] = 0x00FF;//bit 15~0,表示本例子只使用0~7信道
